...
export default function Footer() {
  return (
    <footer className="bg-[var(--blade-charcoal)] text-white">
      {/* Main Footer */}
      <div className="container-custom py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-[var(--blade-silver)] mb-6 leading-relaxed">
              Professional landscaping services in San Antonio, TX. We transform outdoor spaces
              into beautiful, functional landscapes that you&apos;ll love.
            </p>
            <div className="text-xs uppercase tracking-[0.2em] text-white/50 mb-3">
              Follow us on Insta and Nextdoor!
            </div>
            ...
            <ul className="space-y-3">
              {services.map((service) => (
                <li key={service}>
                  <Link
                    href="/services"
                    className="text-[var(--blade-silver)] hover:text-[var(--blade-green-light)] transition-colors"
                  >
                    {service}
                  </Link>
                </li>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                <svg
                  className="w-5 h-5 mt-1 text-[var(--blade-green-light)]"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
                ...
                <span className="text-[var(--blade-silver)]">San Antonio, TX</span>
              </div>
              <div className="flex items-start gap-3">
                <svg
                  className="w-5 h-5 mt-1 text-[var(--blade-green-light)]"
              ...
              <div className="flex items-start gap-3">
                ...
                <a
                  href="mailto:info@bladelandscaping.com"
                  className="text-[var(--blade-silver)] hover:text-[var(--blade-green-light)] transition-colors"
                >
      ...
      {/* Bottom Footer */}
      <div className="border-t border-[var(--blade-slate)]">
        <div className="container-custom py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-[var(--blade-silver)] text-sm">
              &copy; {new Date().getFullYear()} Blade Landscaping. All rights reserved.
            </p>
            <div className="flex gap-6 text-sm">
              <Link
                href="/privacy"
                className="text-[var(--blade-silver)] hover:text-white transition-colors"
              >
                Privacy Policy
              </Link>
              <Link
